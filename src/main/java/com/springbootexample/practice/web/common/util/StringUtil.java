...
public abstract class StringUtil
{
    ...
    public static String replaceCountryCode(String number,String countryCode)
    {
        try
        {
            ...
            Log.error(TAG, "has no country code" + e.toString());
        }
        return number;
    }
...
//    return ""+result ;
     ...
     * @return
     */
    public static String getNoSSWR2(String doublestr){
//     double d = Double.parseDouble(doublestr);
//    double result = ((int) (d * 100)) / 100.0;   // 不四舍五入
//    return ""+result ;
     ...
     * @return
     */
    public static String getNoSSWR4(String doublestr){
//     double d = Double.parseDouble(doublestr);
//    double result = ((int) (d * 100)) / 100.0;   // 不四舍五入
//    return ""+result ;
        ...
        format.setRoundingMode(RoundingMode.FLOOR);
        String a = format.format(new BigDecimal(doublestr));
        return a.equals("NaN")?"0":a;
    }
    //
    public static String getNoSSWR3(double doublestr){


        DecimalFormat format = new DecimalFormat("0.00");
        String a = format.format(doublestr);
        return a.equals("NaN")?"0.0":a+"";
    }
